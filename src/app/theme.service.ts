...
declare type ThemeString = 'lightTheme' | 'darkTheme';
...
private themes: Record<'lightTheme' | 'darkTheme', Record<string, string>> = {
  ...
  constructor() {
    // TODO: save this to the user profile
    const theme:ThemeString = localStorage.getItem('ui-theme') as ThemeString || 'lightTheme';
  ...
  applyTheme(themeName: ThemeString): void {
